...
enum Reminders {
    private static let identifier = "untangle.daily.reminder"
    ...
    static func schedule(hour: Int, minute: Int) {
        ...
        content.title = "Today's Untangle words are ready"
        content.body = "Five words to unscramble. Keep your streak alive."
